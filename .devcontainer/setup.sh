...
git clone git@github.com:tecno40/spark_backend.git
git clone git@github.com:Spark-Ordering/RequestManager.git
git clone git@github.com:carlosdelivery/SparkPos.git sparkpos
